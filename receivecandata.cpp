...
void ReceiveCANData::run()
{
    ...
    di5Address.can_addr.j1939.addr = 0xFA;           //Enter the address of DI5 here
    ...
    rc40Address.can_addr.j1939.addr = 0x01;           //Enter the address of RC40 here
