...
public:
    TempListItem(QWidget *parent, int rowVal): QWidget(parent) {
        ...
        this->row = new QLabel(QString::number(rowVal + 1), this);
        this->row->setGeometry(0, 0, 210, 15);
        this->row->setStyleSheet("color: #00A6A7");
        this->row->setAlignment(Qt::AlignHCenter);
...
public:
    ...
    CellListItem(QWidget *parent, int rowVal): QWidget(parent) {
        ...
        this->row = new QLabel(QString::number(rowVal + 1), this);
        this->row->setGeometry(0, 0, 28, 20);
        this->row->setStyleSheet("color: #00A6A7;");
        this->row->setAlignment(Qt::AlignHCenter);
